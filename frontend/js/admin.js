...
//   try {
//     const res = await CampusAuth.adminFetch('/admin/stats');
...
//     const res = await CampusAuth.adminFetch('/faqs');

//     let dbFaqs = [];

//     if (res.ok) {
//       dbFaqs = await res.json();
//     }

//     // Convert local FAQ_DB into same format
//     const localFaqs = FAQ_DB.map((f, i) => ({
//       ...f,
//       _id: `local-${i}`
//     }));

//     // Merge both
//     const mergedFaqs = [...localFaqs, ...dbFaqs];

//     renderFAQTable(mergedFaqs);

//   } catch {

//     // If backend fails, show local FAQs only
//     renderFAQTable(
//       FAQ_DB.map((f, i) => ({
//         ...f,
//         _id: `local-${i}`
...
//     msg.textContent =
//       '⚠️ Please fill keywords and English answer';
...
//   try {
//     const res = await CampusAuth.adminFetch('/logs');
